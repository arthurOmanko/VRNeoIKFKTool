...
Advanced IK from HSStudioNEOAddon.dll can manipulate weights of a chara's IK [0..1]. This mod enables to manipulate the weights for both IK/FK by VR controllers. This can be used in order to manipulate selected charas (all/parts) without stopping animation during chara animation on VR environment.  
